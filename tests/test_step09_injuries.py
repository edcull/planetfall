...
class TestNoInjuries:
    def test_no_casualties(self, game_state):
        state = game_state
...
class TestCharacterInjuries:
    ...
    def test_character_death(self, mock_table, game_state):
    ...
    @patch("planetfall.engine.steps.step09_injuries.CHARACTER_INJURY_TABLE")
    def test_character_sick_bay(self, mock_table, game_state):
        from planetfall.engine.dice import TableEntry
        mock_table.roll_on_table.return_value = (
    ...
    @patch("planetfall.engine.steps.step09_injuries.CHARACTER_INJURY_TABLE")
    def test_character_okay_with_xp(self, mock_table, game_state):
        from planetfall.engine.dice import TableEntry
        mock_table.roll_on_table.return_value = (
    ...
    @patch("planetfall.engine.steps.step09_injuries.CHARACTER_INJURY_TABLE")
    def test_character_okay_no_effects(self, mock_table, game_state):
        from planetfall.engine.dice import TableEntry
        mock_table.roll_on_table.return_value = (
    ...
    @patch("planetfall.engine.steps.step09_injuries.CHARACTER_INJURY_TABLE")
    def test_missing_character_skipped(self, mock_table, game_state):
        state = game_state
    ...
    @patch("planetfall.engine.steps.step09_injuries.CHARACTER_INJURY_TABLE")
    def test_boosted_recovery_reduces_sick_bay(self, mock_table, game_state):
        from planetfall.engine.dice import TableEntry
        mock_table.roll_on_table.return_value = (
            RollResult(dice_type="d100", values=[50], total=50, label=""),
            TableEntry(low=41, high=60, result_id="serious_wound",
...
class TestGruntInjuries:
    ...
    def test_grunt_casualties(self, mock_table, game_state):
        from planetfall.engine.dice import TableEntry
    ...
    @patch("planetfall.engine.steps.step09_injuries.GRUNT_INJURY_TABLE")
    def test_all_grunts_survive(self, mock_table, game_state):
        from planetfall.engine.dice import TableEntry
        mock_table.roll_on_table.return_value = (
            RollResult(dice_type="d6", values=[5], total=5, label=""),
            TableEntry(low=4, high=6, result_id="okay", description="Okay",
...
class TestMedEvac:
    @patch("planetfall.engine.steps.step09_injuries.CHARACTER_INJURY_TABLE")
    def test_medevac_picks_better_roll(self, mock_table, game_state):
        from planetfall.engine.dice import TableEntry
