...
class TestRecoveryNoSickBay:
    def test_no_one_in_sick_bay(self):
        state = _make_state()
...
class TestRecoverySickBay:
    def test_character_recovers_one_turn(self):
        state = _make_state()
    ...
    def test_character_still_recovering(self):
        state = _make_state()
        char = state.characters[0]
    ...
    def test_multiple_characters_in_sick_bay(self):
        state = _make_state()
...
class TestExcellentHealthBonus:
    def test_excellent_health_reduces_by_2(self):
        state = _make_state()
        char = state.characters[0]
        char.sick_bay_turns = 3
    ...
    def test_excellent_health_fully_recovers(self):
        state = _make_state()
        char = state.characters[0]
