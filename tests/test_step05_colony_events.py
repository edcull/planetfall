...
class TestColonyEvents:
    ...
    def test_research_points_effect(self, mock_table, game_state):
    ...
    @patch("planetfall.engine.steps.step05_colony_events.COLONY_EVENTS_TABLE")
    def test_build_points_effect(self, mock_table, game_state):
        mock_table.roll_on_table.return_value = (
    ...
    @patch("planetfall.engine.steps.step05_colony_events.COLONY_EVENTS_TABLE")
    def test_morale_effect(self, mock_table, game_state):
        mock_table.roll_on_table.return_value = (
    ...
    @patch("planetfall.engine.steps.step05_colony_events.COLONY_EVENTS_TABLE")
    def test_colony_damage_effect(self, mock_table, game_state):
        mock_table.roll_on_table.return_value = (
    ...
    @patch("planetfall.engine.steps.step05_colony_events.COLONY_EVENTS_TABLE")
    def test_all_xp_effect(self, mock_table, game_state):
        mock_table.roll_on_table.return_value = (
    ...
    @patch("planetfall.engine.steps.step05_colony_events.COLONY_EVENTS_TABLE")
    def test_no_effects(self, mock_table, game_state):
        mock_table.roll_on_table.return_value = (
