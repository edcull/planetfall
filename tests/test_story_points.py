...
class TestSpendToPreventRoll:
    def test_prevent_enemy_activity(self, game_state):
        state = game_state
    ...
    def test_prevent_morale_incident(self, game_state):
        state = game_state
        state.colony.resources.story_points = 1
    ...
    def test_prevent_integrity_failure(self, game_state):
        state = game_state
        state.colony.resources.story_points = 1
    ...
    def test_invalid_roll_type(self, game_state):
        state = game_state
    ...
    def test_insufficient_sp(self, game_state):
        state = game_state
        state.colony.resources.story_points = 0
        events = spend_to_prevent_roll(state, "enemy_activity")
...
class TestSpendForResources:
    ...
    def test_gain_resources(self, mock_roll, game_state):
    ...
    @patch("planetfall.engine.campaign.story_points.roll_nd6")
    def test_capped_by_roll(self, mock_roll, game_state):
        from planetfall.engine.dice import RollResult
...
class TestSpendToIgnoreInjury:
    def test_ignore_injury(self, game_state):
        state = game_state
        state.colony.resources.story_points = 1
...
class TestSpendCrisisReroll:
    def test_crisis_reroll(self, game_state):
        state = game_state
        state.colony.resources.story_points = 1
